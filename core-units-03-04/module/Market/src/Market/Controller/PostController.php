...
{
    // event constants copied from Cache\Module and Notification\Module
	...
	public function indexAction()
    {
    	...
    	if (isset($data['submit'])) {
    		...
    		if (!$this->postForm->isValid($data)) {
    			...
    			// massage data
				$validData = $this->manageValidData($validData);
				...
				if ($this->listingsTable->add($validData)) {
        			...
        			$em->trigger(self::CACHE_EVENT_CLEAR, $this);
					// email notification
        			$em->trigger(self::NOTIFICATION_EVENT_NOTIFY, 
        			             $this,
